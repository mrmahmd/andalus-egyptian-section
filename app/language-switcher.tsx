...
const staffAr: Record<string, string> = {
  ...
  "Teaching Department": "القسم التعليمي", "Administrative Position": "المسمى الإداري", "Administrative Role": "الدور الإداري", "Administrative": "إداري", "English Supervisor": "مشرف اللغة الإنجليزية", "Arabic Supervisor": "مشرف اللغة العربية", "Math & Science Supervisor": "مشرف الماث والساينس", "Deputy": "وكيل", "Department Supervisor": "مشرف شعبة", "Supervised Department": "القسم المُشرف عليه", "Teaching Assignments": "المواد والفصول", "Subject": "المادة", "Grade": "الصف", "Class": "الشعبة", "Add Assignment": "إضافة تكليف", "Add Another Assignment": "إضافة تكليف آخر", "Remember me": "تذكرني", "Forgot password?": "هل نسيت كلمة المرور؟", "First time here?": "هل تزور البوابة لأول مرة؟", "Already have an account?": "لديك حساب بالفعل؟",
