...
Object.assign(staffAr, {
  ...
  "Fully published classes": "الفصول المكتملة النشر",
  "Every assigned teacher is visible": "خطط جميع المعلمين المكلفين ظاهرة",
  "Partially published": "منشورة جزئيًا",
  "Approved teachers are visible; missing teachers stay blank": "خطط المعلمين المعتمدة ظاهرة، وحصص غير المرسلين تبقى فارغة",
  "Includes plans still being written or reviewed": "تشمل الخطط التي ما زالت قيد الكتابة أو المراجعة",
  "Fully published": "مكتملة النشر",
  "Awaiting remaining approvals": "بانتظار باقي الاعتمادات",
  "Each row reflects that teacher's own work only; a partially published class never marks every teacher as published.": "تعرض كل خانة حالة خطة هذا المعلم فقط؛ ونشر جزء من خطة الفصل لا يجعل باقي المعلمين منشورين.",
  "Approved — publication pending": "معتمدة — النشر معلق",
  "This teacher's plan is public": "خطة هذا المعلم منشورة",
  "Approved, publication pending": "معتمدة والنشر معلق",
  "Teacher plans public": "خطط المعلمين المنشورة",
  "This teacher's plan is visible to families": "خطة هذا المعلم ظاهرة لأولياء الأمور",
  "Arabic": "العربية",
...
Object.assign(staffAr, {
  ...
  "2. Class & section": "٢. الفصل والشعبة",
  "2. Teacher": "٢. المعلم",
  "3. Class": "٣. الفصل",
  "Select week": "اختر الأسبوع",
  "Select class": "اختر الفصل",
  "Open waiting plans": "عرض الخطط المعلقة",
  "Select the school week, then the class and section.": "اختر الأسبوع الدراسي ثم الفصل والشعبة.",
  ...
  "This department plan was approved. The class plan is visible when no submitted plan remains under review; missing teachers show Plan not published.": "تم اعتماد خطة القسم. تظهر خطة الفصل عندما لا تبقى أي خطة مرسلة قيد المراجعة، وتظهر حصص المعلمين الذين لم يرسلوا بعبارة Plan not published.",
  ...
  "Send after automatic save": "إرسال بعد انتهاء الحفظ التلقائي",
  "Finishing the automatic save, then the plan will be sent immediately.": "جارٍ إكمال الحفظ التلقائي، ثم ستُرسل الخطة مباشرة.",
  "Sending the weekly plan to your supervisor…": "جارٍ إرسال الخطة الأسبوعية إلى المشرف…",
  "Approving your teaching plan automatically…": "جارٍ اعتماد خطتك التعليمية تلقائيًا…",
  "Approved automatically": "معتمدة تلقائيًا",
  "Approve my teaching plan": "اعتماد خطتي التعليمية",
  "Your teaching plan is approved automatically. The class plan is visible when no submitted plan is still waiting for review; missing teachers appear as Plan not published.": "تُعتمد خطتك التعليمية تلقائيًا. تظهر خطة الفصل عندما لا تبقى أي خطة مرسلة بانتظار المراجعة، وتظهر حصص غير المرسلين بعبارة Plan not published.",
  "Your teaching plan was approved automatically. The class plan is visible when no submitted plan is still waiting for review; missing teachers appear as Plan not published.": "تم اعتماد خطتك التعليمية تلقائيًا. تظهر خطة الفصل عندما لا تبقى أي خطة مرسلة بانتظار المراجعة، وتظهر حصص غير المرسلين بعبارة Plan not published.",
  "Your weekly plan was sent to the supervisor for approval. The class plan is visible when every submitted plan has been approved; missing teachers appear as Plan not published.": "أُرسلت خطتك الأسبوعية إلى المشرف. تظهر خطة الفصل بعد اعتماد كل الخطط المرسلة، وتظهر حصص غير المرسلين بعبارة Plan not published.",
  "Your part is approved. The class plan is visible when no submitted plan is still waiting for review; missing teachers appear as Plan not published.": "تم اعتماد الجزء الخاص بك. تظهر خطة الفصل عندما لا تبقى أي خطة مرسلة بانتظار المراجعة، وتظهر حصص غير المرسلين بعبارة Plan not published.",
  "Your teaching plan is approved automatically when sent. Missing teachers do not block the class plan and appear as Plan not published.": "تُعتمد خطتك التعليمية تلقائيًا عند إرسالها. المعلمون الذين لم يرسلوا لا يمنعون نشر خطة الفصل، وتظهر حصصهم بعبارة Plan not published.",
  "Save privately as a draft, then send the completed plan to your supervisor. Missing teachers do not block an otherwise approved class plan.": "احفظ خطتك كمسودة خاصة، ثم أرسلها إلى المشرف عند اكتمالها. المعلمون الذين لم يرسلوا لا يمنعون نشر خطة الفصل بعد اعتماد الخطط المرسلة.",
  "The class plan becomes visible when every submitted plan is approved. Teachers who did not submit remain visible as Plan not published.": "تظهر خطة الفصل عند اعتماد كل الخطط المرسلة. وتظهر حصص المعلمين الذين لم يرسلوا بعبارة Plan not published.",
  "Confirm automatic approval": "تأكيد الاعتماد التلقائي",
  "Your own teaching lessons will be approved automatically. The class plan is visible when no submitted plan remains under review; missing teachers show Plan not published.": "ستُعتمد حصصك التعليمية تلقائيًا. تظهر خطة الفصل عندما لا تبقى أي خطة مرسلة قيد المراجعة، وتظهر حصص غير المرسلين بعبارة Plan not published.",
  "Yes, approve my plan": "نعم، اعتماد خطتي",
  "Autosaving — approve next": "جارٍ الحفظ التلقائي — ثم الاعتماد",
