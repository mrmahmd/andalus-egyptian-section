...
Object.assign(staffAr, {
  ...
  "Your teaching plan is approved automatically. It appears in your dashboard now; families see the class plan only after every required plan is approved.": "اعتُمدت خطتك التعليمية تلقائيًا وتظهر الآن في لوحة تحكمك؛ ولن تظهر خطة الفصل لأولياء الأمور إلا بعد اعتماد جميع الخطط المطلوبة.",
  "Your teaching plan is approved automatically when sent. Families see the class plan only after all required plans are approved.": "تُعتمد خطتك التعليمية تلقائيًا عند إرسالها، ولا يرى أولياء الأمور خطة الفصل إلا بعد اعتماد جميع الخطط المطلوبة.",
  "Your teaching plan was approved automatically. It is visible in your dashboard, and families will see the class plan only after every required plan is approved.": "تم اعتماد خطتك التعليمية تلقائيًا وهي ظاهرة في لوحة تحكمك، ولن يرى أولياء الأمور خطة الفصل إلا بعد اعتماد جميع الخطط المطلوبة.",
  "Confirm automatic approval": "تأكيد الاعتماد التلقائي",
  "Your own teaching lessons will be approved automatically. The class plan will remain hidden from families until every required plan is approved.": "ستُعتمد حصصك التعليمية تلقائيًا، وستظل خطة الفصل مخفية عن أولياء الأمور حتى اعتماد جميع الخطط المطلوبة.",
