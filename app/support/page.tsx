...
export default function SupportPage() {
  ...
  return <main className="support-page">
    <header className="compact-header support-header"><Link href="/" className="brand-lockup"><img src={`${basePath}/school-logo.jpeg`} alt="AlAndalus Private Schools" /><span className="brand-copy"><strong>ALANDALUS PRIVATE SCHOOLS</strong><small>Egyptian Section</small></span></Link><nav aria-label="Main navigation"><Link href="/">Home</Link><Link href="/weekly-plan">Weekly Plan</Link><Link href="/timetable">Timetable</Link><Link className="active" href="/support">Technical Support</Link></nav><Link className="button button-outline" href="/">Back to Home</Link></header>
