        ...
        <div className="teacher-modal-backdrop" role="presentation" onMouseDown={(event) => event.target === event.currentTarget && setWeeklyBuilderOpen(false)}>
          <section className="teacher-editor-modal weekly-builder-modal" role="dialog" aria-modal="true" aria-labelledby="weekly-builder-title">
            ...
            <form onSubmit={(event) => { event.preventDefault(); setWeeklyBuilderOpen(false); }}>
              ...
              <section className="weekly-builder-extra"><div className="weekly-builder-section-heading"><div><span>QZ</span><div><strong>Quizzes & assessments</strong><small>Add any quiz that families should see below the weekly plan.</small></div></div><button type="button" className="teacher-secondary-button">＋ Add quiz</button></div><div className="weekly-builder-quiz-row"><label>Quiz day<select defaultValue="Tuesday"><option>Sunday</option><option>Monday</option><option>Tuesday</option><option>Wednesday</option><option>Thursday</option></select></label><label>Subject<input defaultValue="English" /></label><label>Quiz title<input placeholder="e.g. Unit 1 vocabulary quiz" /></label><label>Study scope<input placeholder="Words, pages or skills" /></label></div></section>
              <section className="weekly-builder-extra"><div className="weekly-builder-section-heading"><div><span>NT</span><div><strong>Weekly notes for families</strong><small>Spelling words, reminders, materials or important announcements.</small></div></div></div><textarea className="weekly-builder-notes" rows={3} placeholder="e.g. English spelling words: habitat, grow, change · Bring the reading book on Wednesday." /></section>
