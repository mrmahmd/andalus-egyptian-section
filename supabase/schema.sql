...
using ((select private.parent_can_read_approved_plan_content(weekly_plan_id, teacher_id, subject_id)));
...
using ((select private.parent_can_read_approved_plan_content(weekly_plan_id, teacher_id, null)));
