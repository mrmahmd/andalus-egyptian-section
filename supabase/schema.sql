...
from (values
  ...
  ('connect_plus', 'English - Connect Plus', 'اللغة الإنجليزية - Connect Plus', 'English', 'english', 1, 6),
  ('hello', 'English - Hello', 'اللغة الإنجليزية - Hello', 'English', 'english', 7, 9),
  ('hello_plus', 'English - Hello Plus', 'اللغة الإنجليزية - Hello Plus', 'English', 'english', 7, 9),
